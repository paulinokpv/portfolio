...
function Contatos(){
    return(
        <div className="flex flex-col">
            ...
            <div className="md:my-5 md:mx-0 my-5 mx-5 mb-10 p-5 max-w-3xl bg-box-bg-color rounded-lg self-center">
                <h4 className="ml-2 font-bold">ENVIE UMA MENSAGEM:</h4>
                <form className="flex flex-wrap">
                    <input type="text" className="md:p-2.5 m-2.5 p-1.5 rounded-lg border-none flex-1 text-preto" placeholder="Nome"/>
                    <input type="text" className="md:p-2.5 m-2.5 p-1.5  rounded-lg border-none flex-1 text-preto" placeholder="Número do célular"/>
                    <input type="text" className="basis-full md:p-2.5 m-2.5 p-1.5  rounded-lg border-none flex-1 text-preto" placeholder="Email"/>
