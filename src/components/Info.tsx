...
function Info(){
    return(
           <div className="flex justify-between mb-9">
            ...
            <div className="mr-8 -mt-12 flex-1 z-100">
                <div className="p-5 bg-box-bg-color rounded-lg">
                    <h3 className="pb-2 text-4xl font-bold">Desenvolvedor Fullstack</h3>
                    <p className="pb-4 text-xl font-extralight">Com expertise Fullstack, proporciono projetos de alta qualidade, abrangendo front-end e back-end.</p>
                ...
                <div className="my-5 py-5 px-5 bg-box-bg-color rounded-lg flex justify-stretch items-center">
                    ...
                    <div className="w-full pl-4 flex flex-col justify-between gap-1.25">
                        <span>HTML</span>
                        <div className="h-5 rounded-xl bg-bar-color1">
                            <div className="h-5 rounded-xl bg-bar-color2"></div>
                        </div>
                    </div>
                </div>
                <div className="my-5 py-5 px-5 bg-box-bg-color rounded-lg flex justify-stretch items-center">
                ...
                <div className="my-5 py-5 px-5 bg-box-bg-color rounded-lg flex justify-stretch items-center">
                    ...
                    <div className="w-full pl-4 flex flex-col justify-between gap-1.25">
                        ...
                        <div className="h-5 rounded-xl bg-bar-color1">
                            <div className="h-5 rounded-xl w-[80%] bg-bar-color2"></div>
                        </div>
                    </div>
                </div>
                <div className="my-5 py-5 px-5 bg-box-bg-color rounded-lg flex justify-stretch items-center">
                    ...
                    <div className="w-full pl-4 flex flex-col justify-between gap-1.25">
                        ...
                        <div className="h-5 rounded-xl bg-bar-color1">
                            <div className="h-5 rounded-xl w-[90%] bg-bar-color2"></div>
                        </div>
                    </div>
                </div>
                <div className="my-5 py-5 px-5 bg-box-bg-color rounded-lg flex justify-stretch items-center">
